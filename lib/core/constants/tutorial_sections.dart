...
List<TutorialSection> tutorialSections = [
  TutorialSection(
    ...
    videoUrl:
        'assets/tutorials/ios-videos/create-league/create-individual-league.mp4',
  ...
  TutorialSection(
    ...
    videoUrl:
        'assets/tutorials/ios-videos/create-league/create-team-league.mp4',
    androidScreenshotPath:
        'assets/tutorials/android-screenshots/create-league.png',
  ),
  TutorialSection(
    ...
    videoUrl:
        'assets/tutorials/ios-videos/join-league/join-individual-league.mp4',
    androidScreenshotPath:
  ...
  TutorialSection(
    ...
    videoUrl: 'assets/tutorials/ios-videos/join-league/join-team-league.mp4',
    androidScreenshotPath:
  ...
  TutorialSection(
    ...
    videoUrl: 'assets/tutorials/ios-videos/add-event.mp4',
  ...
  TutorialSection(
    ...
    videoUrl: 'assets/tutorials/ios-videos/admin.mp4',
  ...
  TutorialSection(
    ...
    videoUrl: 'assets/tutorials/ios-videos/daily-challenge.mp4',
    androidScreenshotPath:
  ...
  TutorialSection(
    ...
    videoUrl: 'assets/tutorials/ios-videos/drink-games.mp4',
    androidScreenshotPath:
  ...
  TutorialSection(
    ...
    videoUrl: 'assets/tutorials/ios-videos/memories.mp4',
