...
const List<DefaultRule> maleRulesSummer = [
  DefaultRule(
    id: 1,
  ...
  DefaultRule(
    id: 14,
    name: "Scrocca una sigaretta ad una ragazza.",
    type: RuleType.bonus,
    points: 2,
  ),
  DefaultRule(
  ...
  DefaultRule(
    id: 16,
    name:
        "Fingiti un fotografo o pr per rimorchiare ragazze e renditi credibile.",
    type: RuleType.bonus,
    points: 6,
  ),
  DefaultRule(
    id: 17,
    name: "Bacio a tre (idolo).",
    type: RuleType.bonus,
    points: 8,
  ),
  DefaultRule(
  ...
  DefaultRule(
    id: 19,
    name: "Scegli un ragazza e falle un complimento esagerato.",
    type: RuleType.bonus,
    points: 5,
  ),
  // Malus
  ...
  DefaultRule(
    id: 30,
    name: "Floppi sul più bello a letto.",
    type: RuleType.malus,
    points: -5,
  ),
  DefaultRule(
