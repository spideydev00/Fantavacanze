...
class _CreateLeaguePageState extends State<CreateLeaguePage> {
  ...
  void _handlePartnerDestinationSelected(PartnerDestination destination) {
    // Re-tapping the selected package toggles it off and restores the rules of
    // the currently selected GameMode.
    if (_selectedPartnerDestinationId == destination.id) {
      _handleRuleModeChanged(_selectedRuleMode);
      return;
    }
    setState(() {
